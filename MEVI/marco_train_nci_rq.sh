...
python main.py \
    ...
    --cluster_path ${DATA_DIR}/${DOCUMENT_ENCODER}/rqclus${LABEL_LENGTH}_${CODE_BITS}.pkl \
    --mapping_path ${DATA_DIR}/${DOCUMENT_ENCODER}/rqmapping${LABEL_LENGTH}_${CODE_BITS}.pkl \
    --data_dir ${DATA_DIR}/origin \
    --tree_path ${DATA_DIR}/origin/pq_tree${LABEL_LENGTH}_${CODE_BITS}_$KARY.pkl \
